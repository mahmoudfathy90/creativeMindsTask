...
public class TagsEditText extends AutoCompleteTextView {
    ...
    private CloseListener onCloseClickListener;
    public void setOnCloseClickListener(CloseListener onCloseClickListener){
        ...
        sb.setSpan(new ClickableSpan() {
            ...
            public void onClick(View widget) {
                if (onCloseClickListener != null){
                    onCloseClickListener.onClick(tagSpan.getSource());
