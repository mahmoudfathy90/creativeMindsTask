...
public class MVIDelegate<V extends MvpView, P extends MviPresenter<V, ?>> implements FragmentMviDelegate<V, P> {
    ...
    public MVIDelegate(@NonNull MviDelegateCallback<V, P> delegateCallback,
